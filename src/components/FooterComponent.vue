      ...
      <div class="footer-left">
        ...
        <div class="footer-info">
          <div class="footer-info__txt">
            <div class="footer-boxstyle">
              <img
                src="../assets/img/other/LogoPNG.png"
            ...
            <p>
              Box style nace por la pasión de la moda, estilo y el querer
              difundir las maneras de un consumo sustentable y estilo pre loved.
            </p>
          </div>
          <div class="footer-rs" style="margin-top: 10px">
            <!--instagram -->
            <svg
              class="rs-icon"
        ...
        <div class="footer-categories">
          ...
          <div class="footer-categories__blocks">
            <div class="footer-categories__block">
              <a href="#" class="footer-category">Mujer</a>
              <a href="#" class="footer-category">Hombre</a>
              <a href="#" class="footer-category" style="margin-bottom: 2px"
                >Accesorios</a
              >
              <div class="footer-category__double">
                <a href="#" class="footer-category">Mujer </a>
                /
                <a href="#" class="footer-category"> Hombre</a>
              </div>
            ...
            <div class="footer-categories__block">
              ...
              <a href="#" class="footer-category">Thrift Flip</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="footer-right">
        <div class="footer-contact">
          <div class="footer-contact__txt">
            <h3>Contacto</h3>
            <p><b>Telefono:</b> (+503)7832-7854</p>
            <br />
            <p><b>Correo:</b> correoequis@gmail.com</p>
          </div>
        </div>
      </div>
    </footer>
...
.footer-categories__blocks {
  width: 200px;
  justify-content: space-between;
  display: flex;
}

.footer-categories__block {
  display: flex;
  flex-direction: column;
  margin-right: 20px;
}
...
.footer-category__double {
  display: flex;
  color: white;
}

.footer-category__double a {
  font-weight: 500;
  font-style: italic;
  margin-left: 5px;
  margin-right: 5px;
