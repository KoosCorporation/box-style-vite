    ...
    <div class="SingleProductView">
        ...
        <div class="SingleProductView__cont-info">
            ...
            <div class="SingleProductView__cont-info-Bottom">
                ...
                <h2>
                    ${{singelProductGeted.precio}}
                </h2>
            </div>

            <div class="SingleProductView_how">
                <h2>Como comprar ? </h2>

                <p>Si te gusto este producto tomale una captura y envialo a cualquiera de nuestras redes sociales.</p>
                <div class="SingleProductView_how__RS">
                    <!-- whatsapp // ------------------------ -->
                    <a href="">
                        <svg class="SingleProductView_how__whatsapp" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24">
                            <path
